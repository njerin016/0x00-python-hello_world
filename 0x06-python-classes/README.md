0x06-python-classes contains files with tasks on classes and objects.

main.py files - are the test cases files
...
7. 100-singly_linked_list.py - a class Node that defines a node of a singly linked list.
...
10. 103-magic_class.py - Python class MagicClass that does exactly the same as the following Python bytecode:
